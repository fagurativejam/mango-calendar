{
  ...
  outputs = { self, nixpkgs, utils }:
    utils.lib.eachDefaultSystem (system:
      ...
      in {
        # --- 1. NEW: Package compilation derivation output ---
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "mango-calendar";
          version = "1.0.0";
          src = ./.; # Automatically packages your main.lua and theme.lua files
        ...
        # --- 2. RETAINED: Your existing local development environment ---
